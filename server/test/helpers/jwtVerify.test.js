...
describe('Testing JWT Verification Helper', function () {
  ...
  it('should return a decoded JWT', function () {
    const payload = jwtVerify('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.KX8kzUd8mN1BxR3iPZWXc7gKQDMa5GgxlY-Tp-ih89A', config.get('jwt.secret'));
